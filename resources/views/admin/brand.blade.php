...
@section('content')
    <div id="napp" class="container mt-5">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
              ...
              <p class="lead">Formulario para cadastro de marcas</p>
            </div>
          </div>
        ...
        <form :id="formid" :name="formid" class="mt-0">
            ...
            <div class="form-group">
                ...
                <input v-model="form.name" v-on:keydown.enter="save()" name="name" id="name" type="text" class="form-control" placeholder="Nome">
            </div>   
        ...
        <div class="row justify-content-center mt-2">
            <ul class="list-group">
                <a v-for="(item, key) in brandIndex" :key="`item-${key}`" @click="showItem(item)" href="#" class="list-group-item" v-bind:class="{ 'list-group-item-primary': key % 2 == 0 }">
                    Nome: @{{ item.name }}
                </a>
            </ul>   
        </div>
    ...
    <script>
        const napp = new Vue({
            ...
            methods: {
                getBrandIndex() { // requests the brand's index 
                ...
                excluir() {
                    this.submit('post', '/brand/destroy')
                        .then(response => {  
